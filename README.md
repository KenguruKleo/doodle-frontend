...
- **`createEntityAdapter`**: Automatically normalizes the Redux state and handles deduplication by `_id`. This elegantly prevents race conditions or duplicate data injections when using cursor-based pagination.
